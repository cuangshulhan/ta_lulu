...
<body>
                ...
                <div class="collapse mb-4 <?= $show ?>" id="formDataAdd">
                    <div class="card">
                        <div class="card-header bg-success">
                            <span class="btn btn-success">Tambahkan data Kendaaran</span>
                        </div>
                        <div class="card-body">
                            <?php echo form_open('kendaraanController/insert'); ?>
                            <div class="form-group">
                                <label>Plat Kendaraan</label>
                                <?php echo form_error('plat', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                                <input type="text" class="form-control" name="plat" id="plat" value="<?php echo set_value('plat'); ?>" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <label>Merek Kendaraan</label>
                                <?php echo form_error('merek', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                                <input type="text" class="form-control" name="merek" id="merek" value="<?php echo set_value('merek'); ?>" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <label>Tipe Kendaraan</label>
                                <?php echo form_error('tipe', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                                <input type="text" class="form-control" name="tipe" id="tipe" value="<?php echo set_value('tipe'); ?>" autocomplete="off" />
                            </div>
                ...
                <div class="collapse mb-4 <?= $show_edit ?>" id="formDataEdit">
                    <div class="card">
                        <div class="card-header bg-primary">
                            <span class="btn btn-primary">Edit data Kendaaran</span>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="color: white;" onclick="closeEdit()">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="card-body">
                            <?php echo form_open('kendaraanController/update'); ?>
                            <input type="hidden" class="form-control" name="id" id="id" value="<?php echo set_value('id'); ?>" />
                            <div class="form-group">
                                <label>Plat Kendaraan</label>
                                <?php echo form_error('plat_edit', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                                <input type="text" class="form-control" name="plat_edit" id="plat_edit" value="<?php echo set_value('plat_edit'); ?>" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <label>Merek Kendaraan</label>
                                <?php echo form_error('merek_edit', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                                <input type="text" class="form-control" name="merek_edit" id="merek_edit" value="<?php echo set_value('merek_edit'); ?>" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <label>Tipe Kendaraan</label>
                                <?php echo form_error('tipe_edit', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                                <input type="text" class="form-control" name="tipe_edit" id="tipe_edit" value="<?php echo set_value('tipe_edit'); ?>" autocomplete="off" />
                            </div>
    ...
    <script>
        ...
        btnEdit = (id) => {
            $.ajax({
                url: "<?php echo base_url('kendaraanController/edit'); ?>",
                type: 'post',
                data: {
                    id: id,
                },
        ...
        Datatable = () => {
            ...
            $.ajax({
                url: "<?php echo base_url('kendaraanController/datatable'); ?>",
                type: 'post',
                data: {
                    limit: limit,
                    page: page,
                        ...
                        for (let i = 0; i < data.length; i++) {
                            ...
                            dataTable = dataTable + `<tr>
                                ...
                                <td class="text-center">
                                   ...
                                   <a href="<?= base_url() ?>kendaraanController/delete/${data[i].id}" onclick="return confirm('Apa kamu yakin akan menghapus data item ini?');">
